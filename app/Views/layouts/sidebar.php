...
// Get notification counts jika user adalah admin
$notificationCounts = [];
if ($role === 'admin') {
    ...
    $notificationCounts = [
        'pembayaran_pending' => $pembayaranModel->countPending(),
        'dokumen_pending' => $pendaftaranModel->countPendingDocumentVerification(),
        'penerimaan_pending' => $pendaftaranModel->countPendingAcceptanceAnnounce()
    ];
}
?>
...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1 ps">
        <!-- DASHBOARD -->
        <li class="menu-item <?= ($currentUri == '' || strpos($currentUri, $dashboardPath) !== false) ? 'active' : '' ?>">
